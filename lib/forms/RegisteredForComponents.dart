...
class RegisteredForComponents extends StatefulWidget {
  @override
  _RegisteredForComponents createState() => _RegisteredForComponents();
}

class _RegisteredForComponents extends State<RegisteredForComponents> {
  ...
  bool isIssued = false;
  String? _mobileNo, _collegeName, _course, _yearOfStudy, _componentsName;
  late bool _loading;
  File? file;
  ...
  Widget build(BuildContext context) {
    ...
    var members = ComponentsIssuedService();
...
//     // alert after successful form submission
    Widget okButton = TextButton(
      ...
      onPressed: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const ComponentIssued()),
        );
      },
    );
    ...
    AlertDialog alert = AlertDialog(
      content: Text(
        "Components issued form Submitted Successfully. Check your mail for confirmation",
        style: kLabelStyle,
      ),
      actions: [
        okButton,
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appBar(
          context,
          strTitle: "Register For Components",
          isDrawer: false,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      textCapitalization: TextCapitalization.words,
                      controller: componentsNameController,
                      minLines: 1,
                      maxLines: null,
                      style: TextStyle(
                        color: Colors.black,
                      ...
                      keyboardType: TextInputType.text,
                      decoration: formField.copyWith(
                          hintText: "Enter Name of The Components"),
                      validator: (value) {
                        if (value!.isEmpty) {
                          return 'Please enter Name of The Components';
                        }
                        return null;
                      },
                      onSaved: (value) {
                        _componentsName = value!;
                      },
                    ),
                  ),
                  Container(
                              ...
                              if (!_formKey.currentState!.validate()) {
                                ...
                                if (filePicked) {
                                  await saveImg(
                                    ...
                                    'registeredForComponents/${nameController.text}_${mobileNoController.text}',
                                  );
                                  ...
                                  print("saved");
                                  EmailService2().sendComponentsRegistrationEmail(
