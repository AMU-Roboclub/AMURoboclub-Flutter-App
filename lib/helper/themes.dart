...
final ThemeData lightTheme = ThemeData(
 ...
 if (states.contains(WidgetState.selected)) { return Color(0xff4a23a9); }
 return null;
 }),
 ...
 return null;
  ...
  })).copyWith(secondary: Color(0xff5c2cd3)).copyWith(surface: Color(0xffbeabed)).copyWith(error: Color(0xffd32f2f)),
...
final ThemeData darkTheme = ThemeData(
 ...
 // primaryColorBrightness: Brightness.dark,
  ...
  })).copyWith(surface: Color(0xff616161)).copyWith(error: Color(0xffd32f2f)), checkboxTheme: CheckboxThemeData(
 fillColor: WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) {
 if (states.contains(WidgetState.disabled)) { return null; }
 if (states.contains(WidgetState.selected)) { return Color(0xff673bd6); }
 return null;
 }),
 ), radioTheme: RadioThemeData(
 fillColor: WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) {
